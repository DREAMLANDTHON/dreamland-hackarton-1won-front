...
import WholeDrink from '../imgs/whole_drink.png';
...
export default function CateListDrink() {
  ...
  return (
    <>
      ...
      <Page>
        <Container>
          <TitleGrids>
            <Logo src={WholeDrink} alt="img" />
            <div>
              <Title>Drink</Title>
              <SubTitle>음료</SubTitle>
            </div>
          </TitleGrids>
          <ItemContainer>
